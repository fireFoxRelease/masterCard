...
int status;
#define CHN_NO 0
#define ASYN_SEND_MODE 1 /*0 send by offset, 1:send back to back*/
...
int main() 
{
	...
	hiMil1394MsgSpeedSet(pDev, 1, SEND_SPEED);
	...
	hiMil1394NodeModeSet(pDev, 1, 1); //0:cc 1;RN BM:2
    ...
    hiMil1394STOFWrite(pDev, chn, 1, &sendPac);
	...
	sendAsynData.STOFTransmitOffset = 300;
